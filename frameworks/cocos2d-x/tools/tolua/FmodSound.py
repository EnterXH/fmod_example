...
def _check_ndk_root_env():
    ...
    try:
        NDK_ROOT = '/Users/Enter/work/android-ndk-r16b'#os.environ['NDK_ROOT']
    except Exception:
...
def main():
    ...
    try:
        ...
        output_dir = '%s/cocos/scripting/lua-bindings/fmod' % project_root

        cmd_args = {'FmodSound.ini' : ('FmodSound', 'lua_tools_fmodsound_auto'), \
                    }
        target = 'lua'
